...
public class VTXPlayerView extends RelativeLayout {

	public VTXPlayerView(Activity activity) {
		super(activity);
		init(activity);
	}

	public VTXPlayerView(Activity activity, AttributeSet attrs) {
		super(activity, attrs);
		init(activity);
	}

	public VTXPlayerView(Activity activity, AttributeSet attrs, int defStyle) {
